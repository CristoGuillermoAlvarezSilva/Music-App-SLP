...
<?php $__env->startSection('content'); ?>
    ...
    <form action="/representantes/<?php echo e($item->id); ?>" class="form-row" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group col-2">
            <h3 for="nombre"><?php echo e($item->nombre); ?></h3>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('../layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\marii\OneDrive\Documentos\GitHub\Music-App-SLP\MusicApp\resources\views/representantes/editar.blade.php ENDPATH**/ ?>